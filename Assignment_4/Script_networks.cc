...
{
  std::string RtsCtsThreshold="0";//there are 4 cases for this
...
void getValues(std::string *tcpVariant)
{
...
int main(int argc,char *argv[])
{
  ...
  getValues(&tcpVariant);   //get parameters
 ...
 // Internet stack 
  ...
  std::cout<<"Hello!! Random Starting Time Generated is:: "<<x<<"\n";
